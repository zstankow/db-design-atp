...
from data_collector import add_players_info, add_tournament_info, add_insta_info
import webscraper
import pymysql
...
def parse():
    ...
    subparsers.add_parser('fill_insta', help="Fill insta infos about player's accounts and posts")
